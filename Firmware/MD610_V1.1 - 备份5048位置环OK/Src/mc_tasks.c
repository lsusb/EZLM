...
//  hElAngle += 10;//SPD_GetInstElSpeedDpp(speedHandle)*PARK_ANGLE_COMPENSATION_FACTOR;
...
//            (int32_t)(FOCVars[M1].Iqdref.d) - Iqd.d);
	...
	Current_IqControl(&aim_iq,&feedbk_iq,&result_iq,0.0625f);
...
void Get_VBusVoltage(void)
{
		RVBS_CalcAvVbus(pBusSensorM1);
		MotorControl.info.VBus = pBusSensorM1->_Super.AvBusVoltage_d;
}
